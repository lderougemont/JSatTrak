...
public class JCoverageDialog extends javax.swing.JPanel
{
    ...
    public JCoverageDialog(CoverageAnalyzer ca, final Time currentJulianDate, JSatTrak app, Hashtable<String, AbstractSatellite> satHash, Vector<J2DEarthPanel> twoDWindowVec)
    {
        ...
        {
            ((DefaultListModel<String>)satIncludedList.getModel()).addElement(name);
        }
        // add current sat list
        for(AbstractSatellite sat : satHash.values())
        {
            ((DefaultListModel<String>)availSatList.getModel()).addElement(sat.getName());
        }
        ...
        {
            ((DefaultListModel<String>)twoDWindowList.getModel()).addElement(ep.getName());
    ...
    private void initComponents() {
        ...
        satIncludedList = new javax.swing.JList<String>();
        addSatButton = new javax.swing.JButton();
        jLabel1 = new javax.swing.JLabel();
        jScrollPane2 = new javax.swing.JScrollPane();
        availSatList = new javax.swing.JList<String>();
        ...
        colorMapComboBox = new javax.swing.JComboBox<String>();
        colorMapLabel = new jsattrak.coverage.ColorMapLabel();
        jPanel11 = new javax.swing.JPanel();
        jLabel8 = new javax.swing.JLabel();
        jScrollPane3 = new javax.swing.JScrollPane();
        twoDWindowList = new javax.swing.JList<String>();
        ...
        satIncludedList.setModel(new DefaultListModel<String>());
        ...
        availSatList.setModel(new DefaultListModel<String>());
        ...
        colorMapComboBox.setModel(new javax.swing.DefaultComboBoxModel<String>(new String[] { "Jet", "Cool", "Hot", "Gray" }));
        ...
        twoDWindowList.setModel(new DefaultListModel<String>());
...
private void removeSatButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeSatButtonActionPerformed
    ...
    {
        ((DefaultListModel<String>)satIncludedList.getModel()).remove(selected[i]);
    }
...
private void addSatButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addSatButtonActionPerformed
    ...
    {
        String satName = ((DefaultListModel<String>)availSatList.getModel()).get(selected[i]).toString();
        if(!checkIfStringInList(satName, ((DefaultListModel<String>)satIncludedList.getModel()).toArray()))
        {
            ((DefaultListModel<String>)satIncludedList.getModel()).addElement(satName);
        }
    }
...
private void exportDataButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_exportDataButtonActionPerformed
    ...
    private javax.swing.JList<String> availSatList;
    private javax.swing.JButton clearDataButton;
    private javax.swing.JComboBox<String> colorMapComboBox;
    ...
    private javax.swing.JList<String> satIncludedList;
    ...
    private javax.swing.JList<String> twoDWindowList;
    ...
    private void saveSettings()
    {
        ...
        try
        {
            ...
            for(Object i : ((DefaultListModel<String>)satIncludedList.getModel()).toArray())
            {
                // only adds if isn't already in list
                String satName = i.toString();//((DefaultListModel<String>)satIncludedList.getModel()).get(i).toString();
            ...
            for(J2DEarthPanel ep : twoDWindowVec)
            {
                ...
                {
                    String windowName = ((DefaultListModel<String>)twoDWindowList.getModel()).get(i).toString();
