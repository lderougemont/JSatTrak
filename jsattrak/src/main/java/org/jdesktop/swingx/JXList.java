 ...
 * ListCellRenderer<String> set by client code with a DelegatingRenderer which applies
...
public class JXList<E> extends JList<E> {
     ...
     * entered/exited rows.
     */
    private ListRolloverController<E, JXList<E>> linkController;
...
//--------------------- Rollover support
     ...
     */
    protected ListRolloverController<E, JXList<E>> getLinkController() {
     ...
     * @see org.jdesktop.swingx.rollover.RolloverController
     */
    protected ListRolloverController<E, JXList<E>> createLinkController() {
        return new ListRolloverController<E, JXList<E>>();
    }
    ...
    public void setComparator(Comparator<E> comparator) {
        Comparator<E> old = getComparator();
...
//------------------------- sort: do sort/filter
    ...
    protected SortController<? extends ListModel<E>> getSortController() {
        if (hasSortController()) {
            // JW: the RowSorter is always of type <? extends ListModel<E>>
    ...
    protected ComponentAdapter getComponentAdapter() {
        if (dataAdapter == null) {
            dataAdapter = new ListAdapter<E>(this);
        }
        return dataAdapter;
    }
     ...
     */
    protected static class ListAdapter<E> extends ComponentAdapter {
         ...
         */
        public ListAdapter(JXList<E> component) {
            super(component);
            list = component;
        }
    ...
    public class DelegatingRenderer implements ListCellRenderer<E>, RolloverRenderer {
         ...
         * delegate is null, the default is created via the list's factory method.
         *
         * @param renderer the delegate to use, if null the list's default is
         *   created and used.
         */
        public void setDelegateRenderer(ListCellRenderer<? super E> renderer) {
            if (renderer == null) {
                renderer = createDefaultCellRenderer();
            }
         ...
         */
         ...
         /**
          *
          * @param delegateRenderer2 the renderer to update the ui of.
          */
         private void updateRendererUI(ListCellRenderer<? super E> delegateRenderer2) {
             if (delegateRenderer2 == null) return;
             Component comp = null;
             if (delegateRenderer2 instanceof AbstractRenderer) {
                 comp = ((AbstractRenderer) delegateRenderer2).getComponentProvider().getRendererComponent(null);
             } else if (delegateRenderer2 instanceof Component) {
                 comp = (Component) delegateRenderer2;
             } else {
                 try {
                     comp = delegateRenderer2.getListCellRendererComponent(
