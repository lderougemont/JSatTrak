...
//---------------------------- accessing the target's model: data
    ...
    public boolean isExpanded() {
        return true; // sensible default for JList<String> and JTable
    }
    ...
    public boolean isHierarchical() {
        return false; // sensible default for JList<String> and JTable
    }
     ...
     */
    public int getDepth() {
        return 1; // sensible default for JList<String> and JTable
    }
...
//-------------------- cell coordinate transformations
    ...
    public int convertColumnIndexToView(int columnModelIndex) {
        return columnModelIndex; // sensible default for JList<String> and JTree
    }
    ...
    public int convertColumnIndexToModel(int columnViewIndex) {
        return columnViewIndex; // sensible default for JList<String> and JTree
    }
