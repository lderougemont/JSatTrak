...
public class JXGradientChooser extends JXPanel {
    ...
    private void initComponents() {
        ...
        styleCombo = new javax.swing.JComboBox<GradientStyle>();
        ...
        styleCombo.setModel(new javax.swing.DefaultComboBoxModel<GradientStyle>(new GradientStyle[] { GradientStyle.Linear, GradientStyle.Radial }));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(4, 4, 4, 4);
    ...
    private void initComponents2() {
        ...
        styleCombo.setModel(new DefaultComboBoxModel<GradientStyle>(GradientStyle.values()));
