 ...
 * JList<String> in conjunction with a JTextComponent.
 *
...
public class ListAdaptor extends AbstractAutoCompleteAdaptor implements ListSelectionListener {
     ...
     * completion
     */
    public ListAdaptor(JList<String> list, JTextComponent textComponent) {
     ...
     */
    public ListAdaptor(JList<String> list, JTextComponent textComponent, ObjectToStringConverter stringConverter) {
        this.list = list;
